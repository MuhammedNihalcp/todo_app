...
import 'package:todo_app/util/TextFormFieldWidget/text_form_field_widget.dart';

class ItemsAddScreen extends StatelessWidget {
  ItemsAddScreen({super.key});
              ...
              child: SingleChildScrollView(
                child: Form(
                  ...
                  child: Column(
                    children: [
                      kheight20,
                      additemscontroller.image.isEmpty
                          ? Stack(
                              children: [
                                const CircleAvatar(
                                  radius: 50,
